...
def get_model_for_problem_formulation(problem_formulation_id):
    ...
    Real_uncert = {'Bmax': [5, 400], 'pfail': [0, 1]}  # m and [.]
    ...
    # New problem formulation
      ...
      #  for dike in function.dikelist:
      #      for entry in ['Expected Annual Damage', 'Expected Number of Deaths','Dike Investment Costs]:
      #          o = ScalarOutcome('{}_{}'.format(dike, entry), kind=direction)
      #          outcomes.append(o)
        dikes_variable_names = []
        ...
        outcomes.append(ScalarOutcome('All Costs',
                                             variable_name=[
                                                 var for var in dikes_variable_names],
                                             function=sum_over, kind=direction))
               
        outcomes.append(ScalarOutcome('Total Investment Costs',
                          variable_name=['{}_Dike Investment Costs'.format(dike)
        ...
        outcomes.append(ScalarOutcome('Total Number of Deaths',
                          variable_name=['{}_Expected Number of Deaths'.format(dike)
                                         for dike in function.dikelist],
                          function=sum_over, kind=direction))
